...
него и миграции, и приложение падают на старте. Пустое значение и пробелы тоже
не проходят — проверяется значение, а не факт наличия переменной. Умолчание
здесь было бы опаснее падения: команда ушла бы в служебную базу `postgres`
успешно и молча.
